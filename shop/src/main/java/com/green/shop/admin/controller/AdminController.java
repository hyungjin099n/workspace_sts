...
public class AdminController {
    ...
    public String buyList(Model model, SearchBuyVO searchBuyVO){
    ...
    public String updateItemForm(Model model, @RequestParam(name = "itemCode", required = false, defaultValue = "0") int itemCode){
        //상품 목록 조회
    ...
    public String updateItem(ItemVO itemVO){
        ...
        return "redirect:/admin/updateItemForm?itemCode=" + itemVO.getItemCode();
    }
